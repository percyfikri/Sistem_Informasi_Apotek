...
class PenjualanController extends Controller
{
    ...
    public function cetak_pdf()
    {
        ...
        foreach ($data as $item) {
            ...
            $html .= '<p><strong>3. Jasa:</strong> ' . $item->jasa->nama_jasa . '</p>';
            ...
            $html .= '<tr><th style="border: 1px solid black;">No</th><th style="border: 1px solid black;">Resep</th><th style="border: 1px solid black;">Obat</th><th style="border: 1px solid black;">Kuantitas</th><th style="border: 1px solid black;">Satuan</th><th style="border: 1px solid black;">Subtotal</th></tr>';
            ...
            foreach ($subdata as $subitem) {
                ...
                $html .= '<td style="border: 1px solid black;">' . $subitem->resep->nama_resep . '</td>';
                $html .= '<td style="border: 1px solid black;">' . $subitem->obat->nama_obat . '</td>';
                $html .= '<td style="border: 1px solid black;">' . $subitem->kuantitas . '</td>';
                $html .= '<td style="border: 1px solid black;">' . $subitem->satuan . '</td>';
                $html .= '<td style="border: 1px solid black;">' . $subitem->subtotal . '</td>';
                $html .= '</tr>';
